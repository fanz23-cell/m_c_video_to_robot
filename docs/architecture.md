...
The first stage controls one waist yaw joint and two six-DOF arms. RealSense pitch, wheels, and base motion are held by the official environment defaults.
